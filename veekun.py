...
def csv_to_sqlite():
  ...
  tables = [{'name': 'encounter_condition_value_map',
            ...
            {'name': 'locations',
             ...
             'keys': ['PRIMARY KEY (id)']},
            {'name': 'machines',
             'columns': {'machine_number': 'INTEGER',
                         'version_group_id': 'INTEGER',
                         'item_id': 'INTEGER',
                         'move_id': 'INTEGER'},
             'keys': ['PRIMARY KEY (machine_number, version_group_id)']},
            {'name': 'move_names',
             'columns': {'move_id': 'INTEGER',
                         'local_language_id': 'INTEGER',
                         'name': 'TEXT'},
            ...
            {'name': 'pokemon_move_method_prose',
             'columns': {'pokemon_move_method_id': 'INTEGER',
                         'local_language_id': 'INTEGER',
                         'name': 'TEXT',
                         'description': 'TEXT'},
            ...
            {'name': 'pokemon_move_methods',
             ...
             'keys': ['PRIMARY KEY (id)']},
            {'name': 'pokemon_moves',
             'columns': {'pokemon_id': 'INTEGER',
                         'version_group_id': 'INTEGER',
                         'move_id': 'INTEGER',
                         'pokemon_move_method_id': 'INTEGER',
                         'level': 'INTEGER',
                         'order': 'INTEGER'},
             'keys': ['PRIMARY KEY (pokemon_id, version_group_id, move_id, pokemon_move_method_id, level)']},
